...
<article>
	...
	<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
		...
		$images_con = get_field('construction');
		...
		if( $images_con ): ?>
			...
			<div class="col details">
				...
				<div class="row project-title">
					...
					<h2 class="des_con">Design &amp; Construction</h2>
			...
			<?php 
				...
				if( $images_con ): ?>
				    <ul class="bxslider">
				        <?php foreach( $images_con as $myimage ): ?>
				            <li>
				                <img src="<?php echo $myimage['sizes']['square-large']; ?>" alt="<?php echo $myimage['alt']; ?>" />

				                <p><?php echo $myimage['caption']; ?></p>
				            </li>
				        <?php endforeach; ?>
				    </ul>
